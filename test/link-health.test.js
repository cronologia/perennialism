...
test('deriveUserAgent names the project and has a contact URL', () => {
  assert.match(deriveUserAgent('RCC Brasil'), /^cronologia-check-links\/1\.0 \(RCC Brasil; \+https:\/\/github\.com\/cronologia\/perennialism\)$/);
  assert.match(deriveUserAgent(''), /Perennialism project/);
  assert.match(deriveUserAgent(undefined), /Perennialism project/);
});
