...
- **A THIRD Rama.** In `transcript-64` (Paz e Bem #1294) "Rama" occurs 27 times
  and is the **mythical Vedic figure** of French occultist historiography
  (Saint-Yves d'Alveydre, Schuré) — neither Coomaraswamy. Flagged as a
  disambiguation gap on perennialism#18.
...
<!-- Generated by core/tools/build-keywords.py from perennialism/data/chronology.json (meta.lastUpdated 2026-07-25).
...
|---|---|---|---|
| events | 40 | 1540–2023 | 0 with dateVerified:false |
...
| dataset (all of the above) | - | 1540–2023 | meta.lastUpdated 2026-07-25 |
